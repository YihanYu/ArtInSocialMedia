...
for file in os.listdir('/Users/YihanYu/Desktop/NetworkAnalysis/RandomWalk/Behance'):
    print file
    socialLink=[]
    UserSocial={}
    UserSocial['Google+']=0
    ...
    fileHandle = "/Users/YihanYu/Desktop/NetworkAnalysis/RandomWalk/Behance" + "//" + filename

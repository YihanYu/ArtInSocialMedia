...
def downloadShotList(pageRangeStart, pageRangeEnd):
    shotList=[]
    Url = 'https://api.dribbble.com/v1/shots?sort=views&page={}&access_token=9a7123861f629b903d04c7fdd6d6ed00c124c6d44af05b7c8e9ae9f079064d95'

    for pageNum in range(pageRangeStart, pageRangeEnd):
...
shotList=downloadShotList(20, 30)
print shotList
